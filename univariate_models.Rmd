...
the exception of elevation. Fraser fir (*Abies fraseri*)may correlate better with the
enviornmental variables but it is difficult to tell because it has a cover of
zero in so many plots.
